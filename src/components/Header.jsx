    ...
    return (
        <div className='px-6 py-4 bg-primary flex items-center'>
            ...
            <div className='w-[83%] flex items-center justify-between font-poppins text-white'>
                ...
                <div className='relative w-[25.5%] min-w-104 text-sm'>
                ...
                <div className='flex items-center gap-17.5'>
                    ...
                    <div className='text-lg relative after:absolute after:top-1/2 after:-right-9 after:-translate-y-1/2 after:w-[1px] after:h-8 after:bg-[#7A77FD]'>
                        <ul className='flex items-center gap-x-8 text-lg'>
                            <li className='relative text-[#7A77FD] hover:text-white cursor-pointer text-lg'>
                                <FaShoppingCart  />
                                <span className='absolute bottom-1 left-2 font-bold text-[8px] text-[#615DFA]'>5</span>
                            </li>
                            <li className='relative text-[#7A77FD] hover:text-white cursor-pointer text-lg'>
                                <FaSms  />
                            </li>
